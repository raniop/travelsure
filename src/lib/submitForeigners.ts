...
const buildReadablePayload = (form: ForeignersForm) => {
  ...
  return {
    ...
    summary: {
      ...
      authorizeAgent: form.authorizeAgent ? "כן" : "לא",
      healthAnswersTrue: form.healthAnswersTrue ? "כן" : "לא",
      medicalConfidentialityWaiver: form.medicalConfidentialityWaiver ? "כן" : "לא",
      receivedEssentialInfo: form.receivedEssentialInfo ? "כן" : "לא",
      marketingConsent: yn(form.marketingConsent),
      marketingExtraConsent: yn(form.marketingExtraConsent),
      explainedInUnderstoodLanguage: form.explainedInUnderstoodLanguage ? "כן" : "לא",
      signatureName: form.signatureName,
      signatureDate: form.signatureDate,
      skipPaymentNow: form.skipPaymentNow ? "כן — יטופל טלפונית" : "לא",
      payerLastName: form.payerLastName,
      payerFirstName: form.payerFirstName,
      payerId: form.payerId,
      cardNumber: form.skipPaymentNow ? "" : form.cardNumber,
      cardExp: form.skipPaymentNow ? "" : form.cardExp,
      payerStreetHouse: form.payerStreetHouse,
      payerTown: form.payerTown,
...
export async function submitForeignersApplication(form: ForeignersForm, files: File[]) {
  ...
  const payload = {
    ...
    name: workerName,
    fullName: workerName,
    email: form.email || form.employerEmail || form.payerEmail,
