...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center pt-32 md:pt-24 pb-24 overflow-hidden text-center" style={{ background: 'linear-gradient(135deg, #0f3d3a 0%, #134e4a 30%, #1a6b5f 60%, #22877a 100%)' }}>
      <AnimatedBackground />
      ...
      <div className="container-wide relative z-10">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <div className="flex justify-center">
            <Link to="/purchase">
              <Button variant="cta" size="xl" className="text-lg shadow-[0_10px_40px_rgba(134,239,172,0.5)] hover:shadow-[0_20px_60px_rgba(134,239,172,0.6)] transition-all duration-300 border-2 border-white/30 hover:scale-105" style={{ background: 'linear-gradient(135deg, #86efac 0%, #4ade80 100%)', color: '#134e4a' }}>
                {t("hero.cta")}
                <Plane className="!w-6 !h-6 shrink-0 animate-bounce" style={{ animationDuration: '2s' }} />
              </Button>
            </Link>
          </div>
        </div>
      ...
      >
        <div className="w-8 h-12 rounded-full border-2 border-white/30 backdrop-blur-sm flex items-center justify-center bg-white/5 hover:bg-white/10 hover:border-white/50 transition-all">
