                ...
                <div className="mb-3 grid grid-cols-1 sm:grid-cols-2 gap-2">
                  <div className="relative">
                    {index === 0 && (loading || status.type === "checking") && (
                      <div className="absolute left-0 top-1/2 -translate-y-1/2 z-10 flex items-center gap-2 bg-white/95 backdrop-blur-sm px-3 py-1.5 rounded-lg shadow-md border border-sky-300">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs font-medium text-sky-700 whitespace-nowrap">בודק תעודת זהות במערכת</span>
                        </div>
                      </div>
                    )}
                    <FloatingInput
