                ...
                <div className="mb-3 grid grid-cols-1 sm:grid-cols-2 gap-2">
                  <div className="relative">
                    {index === 0 && (loading || status.type === "checking") && (
                      <div className="absolute left-0 top-1/2 -translate-y-1/2 z-10 flex items-center gap-2 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-lg shadow-sm border border-sky-200">
